...
$routes->put('/editcateg/(:any)', 'WorkController\Postwork::EditCateg/$1');
...
$routes->get('/employmentFlSucAndR/(:any)', 'WorkController\Employment::selEmploymentForFltoSuccessAndReviews/$1');
...
$routes->put('/employmentAccept/(:any)', 'WorkController\Employment::acceptFromFl/$1');
